...
public class MetadataServiceTest {
        ...
        public void testGetPolicy() throws Exception {
                ...
                StreamletDescriptor mockPutStreamlet = new StreamletDescriptor("noop-1",
                                StreamletDescriptor.ExecuteOn.ALL, Hardware.NONE, true);

                Policy expectedPolicy = new Policy("policy123", "kafka", "myScope", "myStream",
                                Arrays.asList(new StreamletExecutionDescriptor(mockPutStreamlet, Region.EDGE,
                                                new ArrayList<>(Collections.emptyList()))),
                                Arrays.asList("bucket1", "local_store"));
