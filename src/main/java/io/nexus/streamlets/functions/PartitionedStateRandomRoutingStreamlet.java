 ...
 * 
 */
public class PartitionedStateRandomRoutingStreamlet extends ByteStreamlet implements DataSourceStreamlet {
    ...
    public PartitionedStateRandomRoutingStreamlet() {
        this.name = "PARTITIONED_ROUTING";
    }
