...
exec java \
    ...
    -Ds3proxy.provider="${S3PROXY_PROVIDER:-filesystem}" \
    -Ds3proxy.identity="${S3PROXY_IDENTITY:-identity}" \
    -Ds3proxy.credential="${S3PROXY_CREDENTIAL:-credential}" \
    ...
    -Djclouds.filesystem-basedir="${JCLOUDS_FILESYSTEM_BASEDIR:-/tmp/blobstore}" \
